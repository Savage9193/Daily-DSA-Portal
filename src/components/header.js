...
export default function Header() {
  ...
  return (
    <header>
      <nav className="z-10 w-full absolute mt-5 ">
          ...
          <div className="flex flex-wrap items-center justify-between py-2 gap-6 md:py-4 md:gap-0 relative">
            ...
            <div
              className="flex-col z-20 flex-wrap gap-6 p-8 rounded-3xl border border-gray-100 bg-white shadow-2xl shadow-gray-600/10 justify-end w-full invisible opacity-0 translate-y-1 absolute top-full left-0 transition-all duration-300 scale-95 origin-top 
                            ...
                            peer-checked:scale-100 peer-checked:opacity-100 peer-checked:visible lg:shadow 
                            dark:shadow-none dark:border-gray-700 "
            >
              <div className="text-gray-700 dark:text-gray-900 lg:pr-4 lg:w-auto w-full lg:pt-0 ">
                <ul className="tracking-wide font-medium lg:text-sm flex-col flex lg:flex-row gap-6 lg:gap-0">
                  ...
                  <li>
                    <Link href="https://leetcode.com/contest/" target="_blank" legacyBehavior>
                      <a
                        className="block md:px-4 transition hover:text-primary"
                      >
                        <span>Contest</span>
