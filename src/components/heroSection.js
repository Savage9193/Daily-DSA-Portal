      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        <div className="relative pt-36 ml-auto">
          <div className="lg:w-2/3 text-center mx-auto">
            ...
            <p className="mt-8 text-gray-700 dark:text-gray-900">
              Your daily fix of coding challenges and insights into Data
              Structures and Algorithms. Level up your coding skills with our
              curated challenges and expert explanations. Join us on a journey
              of growth and mastery in the world of algorithms.
            ...
            <div className="mt-16 flex flex-wrap justify-center gap-y-4 gap-x-6">
              <a
                ...
                className="relative flex h-11 w-full items-center justify-center px-6 before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 sm:w-max"
              >
                <span className="relative font-sans text-lg font-bold pl-6 pr-6 pb-3 pt-3 rounded-lg bg-violet-100 text-violet-700">
                  Get Started
                </span>
              </a>
            </div>
            <div className="hidden py-8 mt-16 border-y border-gray-100 dark:border-white-800 sm:flex justify-between">
              <div className="text-left">
